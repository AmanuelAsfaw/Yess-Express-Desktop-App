        ...
        public static void CreateDB() {
            try
            {
                using (SQLiteConnection sqlite_conn = new SQLiteConnection("Data Source=NewDatabase.db;Version=3;New=True;Compress=True;"))
                {
                    ...
                    {
                        string SenderTable = "CREATE TABLE 'Senders' ('Id' INTEGER NOT NULL, 'Name' TEXT, 'Phone' TEXT UNIQUE, 'CompanyNamdeAddress' TEXT, 'created_at' timestamp DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY('Id' AUTOINCREMENT))";
